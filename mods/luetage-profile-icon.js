...
(function luetageProfileIcon() {
    ...
    function profileImage() {
        const image = document.querySelector('div[class*=field] + .button-toolbar button');
        if (image) {
            ...
            const svgImage = document.querySelector('div[class*=field] + .button-toolbar button svg');
